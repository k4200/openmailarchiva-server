...
<html>
<head>
<title>LDAP Attribute Lookup</title>
...
<table class="sectionheader" width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr > 
    <td width="28%" ><strong><font size=-1>LDAP Attributes Lookup</font></strong></td>
...
<html:form action="/lookuprolecriterion" method="POST">
      ...
      <table class="section2" width="100%" border="0" cellpadding="0" cellspacing="0" >
        ...
        <tr> 
          <td width="5%">&nbsp;</td>
          <td width="90%" align="left"><font size="-1"><c:out value="${configBean.ldapAttributes}" escapeXml="false"/></font></td>
          <td width="5%">&nbsp;</td>
        </tr>
         <tr> 
          <td width="100%" colspan="3">&nbsp;</td>
