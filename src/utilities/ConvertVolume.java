...
public class ConvertVolume {
    ...
    public static void main(String[] param) {
        ...
        salt = param[0];
        passPhrase = param[1];
        System.out.println("salt:"+salt+" passPhrase:"+passPhrase+" storeDir:"+param[2]);
   ...
   public static OutputStream getRawMessageOutputStream(File messageFileName,boolean compress, boolean encrypt) throws Exception  {
	...
	public static void convertMessage(File file) {
	   ...
	   try
	   {
		   ...
		   File tempFile = new File(fileName.substring(fileName.lastIndexOf('.'))+"tmp");
		   initDecryptKey("PBEWithMD5AndDES",salt,passPhrase);
		   initEncryptKey("PBEWithMD5AndTripleDES",salt,passPhrase);
