...
public class MessageStoreException extends ArchivaException implements Serializable {
  ...
  public MessageStoreException(String message, Throwable cause, Logger logger) {
    super(message, cause, logger);
  }
  
  public MessageStoreException(String message, Logger logger, Level level) {
      super(message, logger,level);
  }

  public MessageStoreException(String message, Throwable cause, Logger logger, Level level) {
