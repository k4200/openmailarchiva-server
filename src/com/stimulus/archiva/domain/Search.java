...
public abstract class Search implements java.io.Serializable, Props
{
	...
	protected static Log logger = LogFactory.getLog(Search.class.getName());
	...
	protected DateType			initialDateType	 = DateType.ARCHIVEDATE;
    ...
    public Object clone() {
    	...
    	search.setViewFilter((ViewFilter)viewFilter.clone());
    	search.setAfter(after);
    	search.setBefore(before);
    	...
    	search.setDateType(dateType);
    	search.setLanguage(new String(language));
    	search.setFetchMessage(fetchMessage);
    	search.setInitialDateType(initialDateType);
    ...
    public void initUserSettings(Search sourceSearch) {
    	setViewFilter((ViewFilter)sourceSearch.getViewFilter().clone());
    	setAfter(sourceSearch.getAfter());
    	setBefore(sourceSearch.getBefore());
    	setAttachment(sourceSearch.getAttachment());
    	setDateType(sourceSearch.getDateType());
    	setFlag(sourceSearch.getFlag());
    	setPriority(sourceSearch.getPriority());
    	setSortOrder(sourceSearch.getSortOrder());
    	setDateType(sourceSearch.getDateType());
    	setLanguage(new String(sourceSearch.getLanguage()));
    	setFetchMessage(sourceSearch.getFetchMessage());
    	setInitialDateType(sourceSearch.getInitialDateType());
