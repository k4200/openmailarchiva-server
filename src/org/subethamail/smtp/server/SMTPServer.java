...
import com.stimulus.archiva.domain.FileSystem;
...
{
	private final static Log log = LogFactory.getLog(SMTPServer.class);
	...
	private int port = 8091;	// default to 25
	...
	{
		return this.getName() + " " + Config.getConfig().getApplicationVersion();
	}
