...
{
	private static Logger log = Logger.getLogger(SMTPServer.class);
	...
	private boolean announce_tls = true;
	
	private String name = "SubEthaSMTP";
	...
	public void setAnnounceTLS(boolean announce_tls) {
                this.announce_tls = announce_tls;
    }
 
    public boolean getAnnounceTLS() {
       return this.announce_tls;
    }
	...
	private void initService()
	{
		try
		{
			...
			SMTPCodecFactory factory = new SMTPCodecFactory(Charset.forName(CODEPAGE));
			factory.setEncoderMaxLineLength(10240);
			ProtocolCodecFilter protocol = new ProtocolCodecFilter(factory);
