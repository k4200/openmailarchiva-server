/*
 * $Id: MessageListenerAdapter.java 158 2008-01-08 01:33:30Z jon $
 * $URL: http://subethasmtp.tigris.org/svn/subethasmtp/trunk/smtp/src/org/subethamail/smtp/server/MessageListenerAdapter.java $
 */
	...
	class Handler extends AbstractMessageHandler implements AuthenticationHandler
	{
		...
		public void recipient(String recipient) throws RejectException
		{
			...
			for (MessageListener listener: listeners)
			{
				...
				if (listener.accept(this.from, recipient,ctx.getRemoteAddress()))
				{
